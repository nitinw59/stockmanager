...
?>
  ...
  $(document).ready(function() {
    ...
    $("#btnUpdate").click(function(){
      ...
      var bearer= "Bearer EAAQ6kxBNYfkBAGvkBAeYrJQO34EY96kVmZAPLRJTtqXc5zE7y3aUZCvnlV1yfWlmdv5AJrKZCWZAmcxUOZAZA80SDysUIV4BsqpqL9mBP5N7sDP2c4LZCRQehvo8oS17F1bOaUIqCkl4KlwxJITCz5dfgkUsPB3dn4sMp8d1vCUWi0yBqTsbwVU";
      ...
      $.ajax({
                    type: "post",
                    url: "https://graph.facebook.com/v15.0/100949199614261/messages",
                    headers: auth,
                    data: "{ 'messaging_product': 'whatsapp', 'to': '918087978196', 'type': 'template', 'template': { 'name': 'hello_world', 'language': { 'code': 'en_US' } } }",
