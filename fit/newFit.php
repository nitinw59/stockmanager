...
@media screen and (min-width: 480px) {
  ...
  form {
    ...
    <body>
	<form action="newFitSubmit.php" enctype="multipart/form-data" method="post">
  <center><h3>Fittings </h3></center>
	<label for="mail">Fit Name:  <input type="text" id="Fit" name="Fit" value="" required></label>
	
	<label for="mail">Decription :  <input type="text" id="Decription" name="Decription" value="" ></label>
