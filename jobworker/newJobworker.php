...
@media screen and (min-width: 480px) {
  ...
  form {
	...
	<form action="newjobworkerSubmit.php" enctype="multipart/form-data" method="post">
<center><h3> Style</h3></center>
     
	<label for="mail">jobworker Name:  <input type="text" id="jobworker" name="jobworker" value="" required></label>
	
	<label for="mail">alias :  <input type="text" id="Decription" name="Decription" value="" ></label>
