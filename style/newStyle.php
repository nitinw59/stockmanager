...
@media screen and (min-width: 480px) {
  ...
  form {
    ...
    <body>
    <center><h3>New Style </h3></center>

	<form action="newStyleSubmit.php" enctype="multipart/form-data" method="post">
     
	<label for="mail">Style Name:  <input type="text" id="Style" name="Style" value="" required></label>
