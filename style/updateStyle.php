...
include($_SERVER['DOCUMENT_ROOT']."/htaccess.php");
	...
	$a_old=$_GET['StyleType'];



    $querry="select * from Styletypes where Stylename='$a_old'";
  ...
  $(document).ready(function() {
    ...
    $("#btnUpdate").click(function(){
      ...
      $.ajax({
                    type:"post",
                    url:"styleAction.php",
                    data:"Style="+Style+"&oldStyle="+oldStyle+"&description="+decription+"&action=updateStyle",
        ...
        if(status["STATUS"]==1){
          ...
          window.location.replace("listAllStyleTypes.php");
    ...
    <center><h3>Update Style</h3></center>
	   
	<label for="mail" hidden>Style Name:  <input type="text" id="a_old" name="a_old" value="<?=$a_old?>" hidden></label>
	
    
    <label for="mail">Style Name:  <input type="text" id="Style" name="Style" value="<?=$a?>" required></label>
